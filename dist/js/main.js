...
(function() {
  var LeftMenu, LeftMenuItem, SubMenu, TopMenu, a, closeLeftMenu, determineDepth, div, drawLeftMenu, drawSubMenu, drawTopMenu, dummyMenuData, fitTestText, getParentsOf, hideAllChildrenOf, i, img, li, menuData, ol, openLeftMenu, parseMenu, showAllParentsOf, showFitTest, showSubMenuItems, sizeMatters, span, _ref;
  ...
  drawTopMenu = function() {
    ...
    return $(".top-menu__overflow-content .top-menu__item").on("click", function() {
      return showSubMenuItems($(this));
    });
  };
  ...
  TopMenu = React.createFactory(React.createClass({
    ...
    showSubMenu: function(thing) {
      var caller;
      console.log("show sub menu");
      return caller = thing;
    },
    hideSubMenu: function() {
      return console.log("hide sub menu");
    },
    render: function() {
      ...
      return div({
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          ...
          if (menu_item.children) {
            menu_item_options['data-role'] = 'has_submenu';
            menu_item_options['data-children'] = menu_item.slug;
            menu_item_options.onMouseOver = function(e) {
              return this.showSubMenu(menu_item.slug);
            };
            menu_item_options.onMouseOut = this.hideSubMenu;
          }
          if (menu_item.parent) {
            menu_item_options['data-parent'] = menu_item.parent;
          }
        ...
        onMouseOver: function(e) {
          return this.showSubMenu('overflow');
        },
